<div class="d-flex justify-content-center mb-3" style="width: 80%; margin: 0 auto;">
  <span class="badge badge-light" style="font-size: 1.2rem; padding: 10px 20px;">Wilayah: <?= $detailwilayah['nama_wilayah'] ?? 'Tidak Diketahui' ?></span>
</div>

<div id="map" style="width: 80%; height: 800px; margin: 0 auto;"></div>
